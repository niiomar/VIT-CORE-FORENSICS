...
REQUEST_COUNT = Counter(
    "vitcore_requests_total", "Total HTTP requests", ["method", "path", "status"]
)
REQUEST_LATENCY = Histogram(
    "vitcore_request_latency_seconds", "Request latency in seconds", ["method", "path"]
)
BATCH_SIZE = Histogram(
    "vitcore_batch_size", "Number of files per /api/v1/analyze/batch request",
